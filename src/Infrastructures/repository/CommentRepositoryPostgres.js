...
const GetComment = require("../../Domains/comments/entities/GetComment"); // Pastikan impor ini ada
...
class CommentRepositoryPostgress extends CommentRepository {
  ...
  async getCommentById(commentId) {
    ...
    // Menggunakan GetComment.verifyCommentDeletion untuk mengecek apakah komentar dihapus
    const comment = GetComment.verifyCommentDeletion(result.rows[0]);
  ...
  async getCommentByThreadId(threadId) {
    ...
    // Menggunakan GetComment.verifyCommentDeletions untuk mengecek setiap komentar
    const comments = GetComment.verifyCommentDeletions(result.rows);
