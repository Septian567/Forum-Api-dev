...
describe("ThreadRepositoryPostgres", () => {
  ...
  describe("addNewThread function", () => {
    it("persists a newly added thread", async () => {
      // Arrange
    ...
    it("returns the added thread correctly", async () => {
      // Arrange
      const newThread = new NewThread({
        title: "First thread",
        body: "This is a new thread",
  ...
  describe("getThreadById function", () => {
    it("throws NotFoundError if no thread is found", async () => {
      // Arrange
    ...
    it("retrieves the correct thread", async () => {
      // Arrange
